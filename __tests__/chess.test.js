...
describe('Checkmate', () => {
  ...
  const checks = [
    'rn1qkbnr/p1pppppp/bp6/8/4P3/8/PPPPKPPP/RNBQ1BNR w kq - 2 3',
    // 'rnbqkb1r/p1pppppp/8/1p6/4P1n1/4K3/PPPP1PPP/RNBQ1BNR w kq - 2 4',
    // 'rnb1kbnr/pppp1ppp/8/4p3/4P1q1/6P1/PPPPKP1P/RNBQ1BNR w kq - 1 4',
  ]

  checks.forEach((fen) => {
    const chess = new Chess(fen)
    it('should not be in check', () => {
